                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="title" id="title" value="{{ old('title', $banner->title) }}">
                                    @error('title')
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="url" id="url" value="{{ old('url', $banner->url) }}" class="form-control form-control-sm">
                                    @error('url')
                                        <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
